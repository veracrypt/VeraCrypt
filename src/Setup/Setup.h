...
static wchar_t *szFiles[]=
{
	...
	L"ANOTICE",
	L"AExamPrepSec.exe",
	L"AExamPrepSecExpander.exe",
	L"AExamPrepSec Format.exe",
	L"Averacrypt.inf",
	L"Averacrypt.cat",
	L"Averacrypt.sys",
	L"Dveracrypt.sys",
	L"AExamPrepSec Setup.exe",
	L"XLanguages.zip",
	L"Xdocs.zip",
};
...
static wchar_t *szCompressedFiles[]=
{
	...
	L"LICENSE",
	L"NOTICE",
	L"ExamPrepSec-x64.exe",
	L"ExamPrepSecExpander-x64.exe",
	L"ExamPrepSec Format-x64.exe",
	L"ExamPrepSec-arm64.exe",
	L"ExamPrepSecExpander-arm64.exe",
	L"ExamPrepSec Format-arm64.exe",
	L"veracrypt.inf",
	L"veracrypt-x64.cat",
	L"veracrypt-x64.sys",
...
{
	L"ExamPrepSec-x86.exe",
	L"ExamPrepSecExpander-x86.exe",
	L"ExamPrepSec Format-x86.exe",
	L"ExamPrepSec-x64.exe",
	L"ExamPrepSecExpander-x64.exe",
	L"ExamPrepSec Format-x64.exe",
	L"veracrypt-x64.sys",
